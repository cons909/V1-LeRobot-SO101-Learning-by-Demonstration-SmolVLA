...
MODEL_KEY = "2cam"
MODEL_LABEL = "2 Cameras (side left + side right)"
...
class PiClient:
    ...
    def send_action(self, action_np):
        ...
        (6,)-shaped array in JOINTS order. robot.send_action() (lerobot/robots/so_follower/
        so_follower.py) returns a dict keyed by joint name; this reconstructed server forwards
        that dict as-is. Handle both dict and array shapes."""
        try:
